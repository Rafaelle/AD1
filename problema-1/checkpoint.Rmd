...
Dados de gastos dos deputados de um periodo recente e valor das cotas por estado. Os dados são compostos por 572 parlamentares.
...
Os gastos dos parlamentares são divididos em 18 tipos de categoria.
...
Como podemos observar no gráfico, os três "Tipos de Gasto" com maiores custos da cota dos deputados s?o:
...
Calculando o desvio padrão dos gastos, temos o seguinte gráfico:
...
Análisando por estado, temos a seguinte 
